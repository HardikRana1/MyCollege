...
{
    public abstract class ProHardikV1WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ProHardikV1WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ProHardikV1WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ProHardikV1DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ProHardikV1DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ProHardikV1DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ProHardikV1DbContext, Task<T>> func)
        {
            T result;
